...
const tasks = [
  ...
  {
    input: join(projectRoot, 'src/assets/articles/Evolution of Software Engineering in the Adaptive Future.png'),
    output: join(projectRoot, 'src/assets/articles/Evolution of Software Engineering in the Adaptive Future.webp'),
    options: { width: 700, quality: 85 }
  },
  {
