    ...
    <div className="group cursor-pointer transform transition-all duration-500 hover:scale-105 hover:-rotate-1 h-full">
      <Card className="text-gray-900 rounded-2xl border border-brand-teal/20 bg-white shadow-xl relative backdrop-blur-xl overflow-hidden hover:border-brand-teal/50 hover:shadow-brand-teal/10 hover:shadow-2xl w-full h-full min-h-[420px] flex flex-col">
        <div className="absolute inset-0 z-0 overflow-hidden pointer-events-none">
          ...
          <div className="absolute -bottom-20 -left-20 w-48 h-48 rounded-full bg-gradient-to-tr from-brand-teal/20 to-transparent blur-3xl opacity-30 group-hover:opacity-50 transform group-hover:scale-110 transition-all duration-700"></div>
          <div className="absolute top-10 left-10 w-16 h-16 rounded-full bg-brand-blue/10 blur-xl opacity-40 group-hover:opacity-80 transition-opacity duration-500"></div>
          <div className="absolute bottom-16 right-16 w-12 h-12 rounded-full bg-brand-teal/10 blur-lg opacity-40 group-hover:opacity-80 transition-opacity duration-500"></div>
        ...
        <div className="p-8 relative z-10 flex flex-col items-center text-center h-full justify-between">
          <div className="flex flex-col items-center">
            <div className="relative mb-6">
              <div className="absolute inset-0 rounded-full border border-brand-teal/20 group-hover:border-brand-teal/40 transition-colors duration-300"></div>
          ...
          <div className="w-full flex flex-col items-center mt-2">
            <div className="w-1/3 h-0.5 bg-gradient-to-r from-transparent via-brand-teal to-transparent rounded-full transform group-hover:w-1/2 group-hover:h-1 transition-all duration-500"></div>
