...
const LucidMindTransperentLogo = "/assets/logo/Lucid-mind-logos1.webp";
const LucidMindTransperentLogoMobile = "/assets/logo/Lucid-mind-logos1-mobile.webp";
...
export function Component() {
  ...
  useEffect(() => {
    ...
    const ctx = gsap.context(() => {
      const menuItems = currentContainer.querySelectorAll(
        ".menu-list-item[data-shape]",
      );
      const shapesContainer = currentContainer.querySelector(
  ...
  return (
    <div ref={containerRef}>
      <header className="fixed top-0 left-0 right-0 z-[1001] w-full pointer-events-none">
        <div className="w-full max-w-[1440px] mx-auto px-4 sm:px-6 md:px-8 flex items-center justify-between pt-3 sm:pt-4 pointer-events-auto">
          <Link
            href="/"
            className={`flex items-center transition-all duration-300 ${showLogo
      ...
      <section className="fullscreen-menu-container">
        <div
          data-nav="closed"
          className="nav-overlay-wrapper fixed inset-0 z-1000 hidden"
        >
          <div
          ...
          <nav className="menu-content absolute right-0 top-0 bottom-0 w-full max-w-md bg-linear-to-tr from-[#040914] to-[#4B9AF5] flex flex-col justify-center px-8 sm:px-12 py-10 overflow-hidden shadow-2xl">
            <div className="menu-bg absolute inset-0 overflow-hidden pointer-events-none">
              ...
              <div className="ambient-background-shapes absolute inset-0 pointer-events-none opacity-40">
                <svg
                  className="bg-shape bg-shape-1 absolute inset-0 w-full h-full opacity-0 transition-opacity duration-300"
                  viewBox="0 0 400 400"
                  fill="none"
                >
                  <circle
                ...
                <svg
                  className="bg-shape bg-shape-2 absolute inset-0 w-full h-full opacity-0 transition-opacity duration-300"
                  viewBox="0 0 400 400"
                  fill="none"
                >
                  <path
                ...
                <svg
                  className="bg-shape bg-shape-3 absolute inset-0 w-full h-full opacity-0 transition-opacity duration-300"
                  viewBox="0 0 400 400"
                  fill="none"
                >
                  <circle
                ...
                <svg
                  className="bg-shape bg-shape-4 absolute inset-0 w-full h-full opacity-0 transition-opacity duration-300"
                  viewBox="0 0 400 400"
                  fill="none"
                >
                  <path
                    ...
                    fill="rgba(0,196,255,0.18)"
                  />
                </svg>

                <svg
                  className="bg-shape bg-shape-5 absolute inset-0 w-full h-full opacity-0 transition-opacity duration-300"
                  viewBox="0 0 400 400"
                  fill="none"
                >
                  <line
