    ...
    >
      ...
      <section className="relative w-full bg-[#030A16] py-12 sm:py-16 md:py-20 xl:py-28 px-4 sm:px-8 md:px-10 xl:px-16 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto relative z-10 flex flex-col gap-8 sm:gap-10 xl:gap-14">
            ...
            <div className="flex flex-col lg:flex-row items-center lg:items-start gap-8 sm:gap-10 xl:gap-14">
              ...
              <Reveal variants={fadeRight} className="flex-1">
                ...
                <h3 className="text-xs sm:text-sm xl:text-base font-bold text-[#00C4FF] mt-1.5 sm:mt-2">
                  GCC Leader | Enterprise Reinvention Specialist | Board Advisor
                </h3>
                ...
                <div className="space-y-3 sm:space-y-3.5 text-xs sm:text-[13px] xl:text-sm text-slate-300 leading-relaxed mt-4 sm:mt-5">
                  <p>
                    ...
                    across technology and business leadership, with a career
                    spanning enterprise transformation, global technology
                    operations, product development and organisational scale.
                  </p>
                  <p>
                    He has built and led technology organisations, worked with
                    global leadership teams, scaled a GCC from{" "}
                    <span className="text-[#00E5FF] font-bold">15 to 220+</span>{" "}
                    people, and helped translate emerging technologies into
                    tangible business outcomes.
                  </p>
                  <p>
                    His experience has provided a perspective that goes beyond
                    technology.
                  </p>
                  <p>
                    It is about understanding how{" "}
                    <strong className="text-white font-bold">
                      strategy gets translated into operating reality:
                    </strong>{" "}
                    how people, processes, technology and leadership need to
                    come together for transformation to work.
                  </p>
                  <p>
                    LucidMind is a natural extension of that journey. A platform
                    to bring that experience to organisations navigating their
                    next chapter, helping leadership teams make clearer
                    decisions, build the right capabilities and create
                    organisations that are ready for what comes next.
                  </p>
                </div>
              </Reveal>
            </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 xl:grid-cols-5 gap-2.5 sm:gap-3.5 xl:gap-5">
            {[
              {
