          ...
          <div className="flex flex-col md:flex-row gap-4 md:gap-6 xl:gap-8 items-start">
            <div className="w-full md:w-[300px] xl:w-[420px] 2xl:w-[440px] flex-shrink-0">
              <div className="flex flex-col gap-3.5">
                {podcastsList.slice(0, 6).map((podcast, index) => {
                  ...
                  return (
                    <motion.div
                      ...
                      className={`cursor-pointer rounded-lg flex items-center gap-3 px-3 py-2.5 group transition-all duration-300 ${isActive
                    ...
                    >
                      <div
                        className={`w-9 h-9 rounded-lg flex flex-col items-center justify-center shrink-0 transition-all duration-300 ${isActive
