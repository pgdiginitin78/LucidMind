...
import AdvisoryImg1 from "../../assets/advisory/advisoryImg1.png";
import AINeuralVideo from "../../assets/advisory/AINeural.mp4";
  ...
  return (
    <div className="relative w-full min-h-screen bg-[#040914] text-slate-100 font-plus-jakarta selection:bg-[#00C4B4]/30 selection:text-white overflow-x-hidden">
      <div className="fixed inset-0 pointer-events-none z-0">
        ...
        />
        <div
          className="absolute top-1/3 left-0 -translate-y-1/2 w-96 h-96 pointer-events-none rounded-full blur-[100px]"
          style={{
            background:
        ...
        />
        <div
          className="absolute top-2/3 right-0 -translate-y-1/2 w-96 h-96 pointer-events-none rounded-full blur-[100px]"
          style={{
            background:
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 items-stretch">
            ...
            <div className="group p-5 sm:p-6 rounded-2xl border border-[#142A4A] bg-[#040D1E]/85 hover:border-[#00C4B4]/50 transition-all duration-300 flex flex-col justify-between h-full md:col-span-2 lg:col-span-1">
              <div>
                ...
                <h4 className="text-sm sm:text-base font-serif font-semibold text-white mb-1.5 leading-snug">
                  B2C &amp; Responsible Business Transformation
                </h4>
                <p className="text-[10px] sm:text-[11px] text-slate-400 mb-4 leading-normal">
