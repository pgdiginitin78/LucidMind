            ...
            >
              <TiltCard className="relative flex w-full flex-col justify-center overflow-hidden rounded-[1.5rem]  bg-gradient-to-b from-[#040914] to-[#4B9AF5] p-6 shadow-[0_20px_50px_rgba(0,0,0,0.3)] sm:p-8">
                ...
                <div className="relative z-10 mb-4">
                  ...
                  <Heading
                    level={2}
                    className="text-2xl lg:text-3xl leading-tight tracking-wide text-white sm:text-[1.75rem]"
                  >
                ...
                >
                  {solutions.map((item, idx) => (
                    ...
                    >
                      ...
                      <div className="relative mr-4 flex h-8 w-8 md:h-10 md:w-10 flex-shrink-0 items-center justify-center rounded-full border border-white/10 bg-[#112240] shadow-[0_0_15px_rgba(0,196,180,0.1)] transition-colors duration-300 group-hover:bg-[#1a365d]">
                      ...
                      <div className="flex-1 pr-4">
                        <Heading level={3} className="text-xs md:text-sm text-white">
                          {item.title}
                        </Heading>
                        <p className="mt-1 text-[10px] lg:text-xs leading-snug whitespace-pre-line text-blue-100/60">
                          {item.desc}
                        </p>
                      </div>
